...
let Icons =
  "container flex w-full h-fit items-center px-p20 p-p12 rounded bg-primary-100 justify-center cursor-pointer";
let text =
  "container  w-full h-fit flex items-center px-p24 p-p12 rounded bg-primary-100 justify-center cursor-pointer";
